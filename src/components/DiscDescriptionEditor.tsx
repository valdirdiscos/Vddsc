    ...
    <div className="bg-white rounded-2xl border border-slate-200 p-5 shadow-xs space-y-5" id="disc-description-editor">
      ...
      {activePlatformTab === 'mercadolivre' ? (
        <div className="space-y-4" id="mercadolivre-flow">
          ...
          {/* ========================================================================= */}
          {/* PASSO 3 DO MERCADO LIVRE: CARACTERÍSTICAS / FICHA TÉCNICA (14 CAMPOS) */}
          {/* ========================================================================= */}
          <div className="bg-white rounded-xl border border-slate-200 p-4 space-y-3 shadow-xs">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 border-b border-slate-100 pb-2.5">
              <div className="flex items-center gap-2">
                ...
                <h4 className="text-xs font-black text-slate-900 uppercase tracking-wider">
                  Tela 3: Ficha Técnica (Características Principais do Produto)
                </h4>
              </div>
              <div className="flex items-center gap-2">
                <span className="text-[10px] font-bold text-slate-400">
                  14 campos solicitados no app
                </span>
                <button
                  type="button"
                  onClick={copyAllFichaTecnica}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-2 text-xs">
              {[
                ...
                { key: 'sel', label: 'Companhia Produtora / Selo / Gravadora', val: mlLabel },
                ...
                { key: 'vel', label: 'Velocidade de Reprodução', val: '33 RPM' },
                { key: 'tam', label: 'Tamanho do Disco', val: '12 polegadas' }
              ].map((field) => (
          ...
          {/* ========================================================================= */}
          {/* PASSO 4 DO MERCADO LIVRE: TÍTULO DO ANÚNCIO (MÁXIMO 60 CARACTERES) */}
          {/* ========================================================================= */}
          <div className="bg-white rounded-xl border border-slate-200 p-4 space-y-3 shadow-xs">
          ...
          {/* ========================================================================= */}
          {/* PASSO 5 DO MERCADO LIVRE: SEQUÊNCIA DE FOTOS RECOMENDADA */}
          {/* ========================================================================= */}
          <div className="bg-white rounded-xl border border-slate-200 p-4 space-y-3 shadow-xs">
            <div className="flex items-center justify-between border-b border-slate-100 pb-2">
              <div className="flex items-center gap-2">
                ...
                <h4 className="text-xs font-black text-slate-900 uppercase tracking-wider">
                  Tela 5: Fotos do Produto (Sequência Recomendada)
                </h4>
              </div>
