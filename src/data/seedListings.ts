...
export const SEED_LISTINGS: SavedListing[] = [
  ...
  {
    id: 'listing-lote-classicos-rock-4lp',
    barcode: 'VD-LOTE-4001',
    createdAt: new Date(Date.now() - 3600000 * 24 * 2).toISOString(),
    status: 'available',
    drawer: 'LOTE-ROCK-01',
    quantity: 1,
    salesChannels: ['online_store', 'physical_store'],
    isOnlineExclusive: true,
    onlineExclusiveDetails: 'Lote promocional exclusivo do site com 4 grandes clássicos do Rock em excelente estado de conservação.',
    isLote: true,
    loteItemCount: 4,
    promoActive: true,
    discountPercent: 20,
    ...
    promoPrice: 384,
    promoBadge: '20% OFF',
    bonusDescription: 'Bônus Especial: Plásticos protetores novos 0.20mm em todos os 4 LPs + Flanela antiestática',
    loteItems: [
      {
        id: 'lote-sub-1',
        title: 'The Dark Side of the Moon',
    ...
    release: {
      id: 9991,
      title: 'Lote Especial 4 Discos Rock Clássico: Pink Floyd + Led Zeppelin + Black Sabbath + Queen',
      artist: 'Pink Floyd / Led Zeppelin / Black Sabbath / Queen',
      year: 2024,
      country: 'Brasil',
      label: 'Valdir Discos Combo',
      catno: 'LOTE-4LP-ROCK',
      coverImage: 'https://images.unsplash.com/photo-1514525253161-7a46d19cd819?w=600&auto=format&fit=crop&q=80',
      genres: ['Rock', 'Heavy Metal', 'Lote'],
      styles: ['Classic Rock', 'Hard Rock', 'Heavy Metal', 'Psychedelic Rock', 'Lote Promocional'],
      formats: [{ name: 'Vinyl', qty: '4', descriptions: ['Lote 4xLP', 'Combo Especial'] }],
      tracklist: [
        { position: 'D1', title: '=== DISCO 1: Pink Floyd - The Dark Side of the Moon ===', duration: '' },
        { position: '1-A1', title: 'Speak to Me / Breathe', duration: '3:57' },
        { position: '1-A2', title: 'Time', duration: '6:53' },
        { position: '1-B1', title: 'Money', duration: '6:22' },
        { position: 'D2', title: '=== DISCO 2: Led Zeppelin - Led Zeppelin IV ===', duration: '' },
        { position: '2-A1', title: 'Black Dog', duration: '4:56' },
        { position: '2-A4', title: 'Stairway to Heaven', duration: '8:02' },
        { position: 'D3', title: '=== DISCO 3: Black Sabbath - Paranoid ===', duration: '' },
        { position: '3-A1', title: 'War Pigs', duration: '7:57' },
        { position: '3-A2', title: 'Paranoid', duration: '2:48' },
        { position: '3-A4', title: 'Iron Man', duration: '5:56' },
        { position: 'D4', title: '=== DISCO 4: Queen - A Night at the Opera ===', duration: '' },
        { position: '4-B1', title: 'Bohemian Rhapsody', duration: '5:55' }
      ],
      notes: 'Lote promocional exclusivo com 4 discos clássicos essenciais de rock internacional em vinil higienizado.'
    },
    condition: {
      mediaCondition: 'EX',
    ...
    shopee: {
      title: 'Lote 4 Discos Vinil Rock Pink Floyd Led Zeppelin Black Sabbath Queen',
      description: 'Combo imperdível com 4 clássicos essenciais do Rock internacional.',
      suggestedPrice: 384,
      hashtags: ['#loterock', '#vinil', '#pinkfloyd', '#ledzeppelin', '#promocao']
    }
  },
  {
    id: 'listing-racionais-mcs-1997',
    barcode: 'VD-001997-RAP',
    createdAt: new Date(Date.now() - 3600000 * 24 * 1).toISOString(),
    status: 'available',
    drawer: 'Gaveta R1 - Rap & Hip-Hop Nacional',
    quantity: 1,
    salesChannels: ['online_store', 'physical_store'],
    isOnlineExclusive: false,
    isDoubleAlbum: true,
    ...
    promoPrice: 187,
    promoBadge: '15% OFF',
    bonusDescription: 'Bônus: Encarte duplo fac-símile com letras completas + Plásticos duplos 0.20mm',
    release: {
      id: 9992,
      ...
      catno: 'CN-001',
      coverImage: 'https://images.unsplash.com/photo-1508700115892-45ecd05ae2ad?w=600&auto=format&fit=crop&q=80',
      genres: ['Hip-Hop', 'Rap', 'Música Brasileira'],
      styles: ['Rap Nacional', 'Boom Bap', 'Conscious Hip-Hop'],
      formats: [{ name: 'Vinyl', qty: '2', descriptions: ['2xLP', 'Gatefold'] }],
      tracklist: [
        { position: 'A1', title: 'Jorge da Capadócia', duration: '2:40' },
        { position: 'A2', title: 'Genesis', duration: '0:23' },
        { position: 'A3', title: 'Capítulo 4, Versículo 3', duration: '8:09' },
        { position: 'B1', title: 'Tô Ouvindo Alguém Me Chamar', duration: '11:13' },
        { position: 'C1', title: 'Diário de um Detento', duration: '7:31' },
        { position: 'C2', title: 'Periferia É Periferia (Em Qualquer Lugar)', duration: '6:01' },
        { position: 'D1', title: 'Fórmula Mágica da Paz', duration: '10:40' }
      ],
      notes: 'Edição histórica em vinil duplo do álbum mais icônico do rap brasileiro.'
    },
    condition: {
      mediaCondition: 'NM',
      mediaDetails: 'Vinis em perfeito estado, áudio cristalino e potente.',
      sleeveCondition: 'NM',
      sleeveDetails: 'Capa dupla gatefold impecável.',
      hasInsert: true
    },
    pricing: {
      costPrice: 90,
    ...
    shopee: {
      title: 'LP Vinil Duplo Racionais MCs Sobrevivendo no Inferno 15% OFF',
      description: 'Obra prima do Hip-Hop nacional com Capítulo 4 Versículo 3 e Diário de um Detento.',
      suggestedPrice: 187,
      hashtags: ['#rapnacional', '#racionais', '#hiphop', '#vinilduplo', '#promocao']
    }
  }
];
